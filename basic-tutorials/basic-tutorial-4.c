    ...
    do{
        ...
        if(msg != NULL){
            ...
            if(data.playing){
                ...
                /* If we didn't know it yet, query teh stream duration */
                ...
                /* If seeking is enbabled, we have not done it yet, and the time is right, seek */  
                if(data.seek_enabled && !data.seek_done && current > 10 * GST_SECOND){
                    g_print("\nReached 10s, performaing seek...\n");
    ...
    switch(GST_MESSAGE_TYPE(msg)){
        ...
        case GST_MESSAGE_STATE_CHANGED: {
            ...
            if(GST_MESSAGE_SRC(msg) == GST_OBJECT (data->playbin)){
                ...
                /* Remeber whether we are in the  PLAYING state or not */
